...
<div class="row">
<div class="col-lg-6">
<span class="logo">TECH IQ QUIZ</span></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="Aryan Dalvi" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Aryan Dalvi</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+911234567890</h4>
		<h4 style="font-family:'typo' ">aryandalvi18@gmail.com</h4>
		<h4 style="font-family:'typo' ">KJSCE, Vidyavihar</h4></div></div>
		</p>
      </div>
